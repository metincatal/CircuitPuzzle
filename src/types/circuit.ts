...
const DIFFICULTY_MILESTONES: DifficultyMilestone[] = [
    ...
    { level:  120, rows:  8, cols:  7, structureCount: 2, bridgeChance: 0.16, doubleCornerChance: 0.10, diodeChance: 0.14, switchChance: 0.10, blockerChance: 0.04, fixedChance: 0 },
    { level:  180, rows:  8, cols:  7, structureCount: 2, bridgeChance: 0.18, doubleCornerChance: 0.12, diodeChance: 0.16, switchChance: 0.12, blockerChance: 0.05, fixedChance: 0 },
    { level:  250, rows:  8, cols:  8, structureCount: 3, bridgeChance: 0.20, doubleCornerChance: 0.14, diodeChance: 0.18, switchChance: 0.14, blockerChance: 0.06, fixedChance: 0 },
    { level:  350, rows:  9, cols:  8, structureCount: 3, bridgeChance: 0.22, doubleCornerChance: 0.16, diodeChance: 0.20, switchChance: 0.16, blockerChance: 0.07, fixedChance: 0 },
    { level:  500, rows:  9, cols:  8, structureCount: 3, bridgeChance: 0.25, doubleCornerChance: 0.18, diodeChance: 0.22, switchChance: 0.18, blockerChance: 0.08, fixedChance: 0 },
    { level:  700, rows:  9, cols:  9, structureCount: 4, bridgeChance: 0.28, doubleCornerChance: 0.20, diodeChance: 0.25, switchChance: 0.20, blockerChance: 0.09, fixedChance: 0 },
    { level: 1000, rows: 10, cols:  9, structureCount: 4, bridgeChance: 0.30, doubleCornerChance: 0.22, diodeChance: 0.28, switchChance: 0.22, blockerChance: 0.10, fixedChance: 0 },
    { level: 1500, rows: 10, cols: 10, structureCount: 5, bridgeChance: 0.33, doubleCornerChance: 0.25, diodeChance: 0.30, switchChance: 0.25, blockerChance: 0.11, fixedChance: 0 },
    { level: 2000, rows: 11, cols: 10, structureCount: 5, bridgeChance: 0.35, doubleCornerChance: 0.28, diodeChance: 0.33, switchChance: 0.28, blockerChance: 0.12, fixedChance: 0 },
    { level: 2500, rows: 11, cols: 10, structureCount: 5, bridgeChance: 0.38, doubleCornerChance: 0.30, diodeChance: 0.35, switchChance: 0.30, blockerChance: 0.13, fixedChance: 0 },
    { level: 3000, rows: 12, cols: 10, structureCount: 6, bridgeChance: 0.40, doubleCornerChance: 0.32, diodeChance: 0.38, switchChance: 0.32, blockerChance: 0.14, fixedChance: 0 },
    { level: 4000, rows: 12, cols: 11, structureCount: 6, bridgeChance: 0.45, doubleCornerChance: 0.35, diodeChance: 0.40, switchChance: 0.35, blockerChance: 0.15, fixedChance: 0 },
];
